    ...
    return (
      <View style={styles.container}>
        <View style={styles.storyContainer}>
          <View>
              <Text> Pilih lah gejala dibawah ini yang kamu rasakan </Text>
          </View>
          <FlatList data={this.state.fakeContact} keyExtractor={item => item.id} extraData={this.state} renderItem={({item}) => {
